...
fig.tight_layout()  # Adjust the rect parameter to leave space for the top suptitles

plt.savefig("all_structures.pdf", bbox_inches='tight')
plt.savefig("all_structures.png", dpi=300, bbox_inches='tight')
