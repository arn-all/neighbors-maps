...
class NeighborMap:
    ...
    def __init__(self, atoms, gamma=2, beta=3) -> None:
        self.gamma = gamma
        self.beta = beta
...
class Atoms(ase.Atoms):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.neighbor_map = NeighborMap(self)
    ...
    def get_neighbor_map(self, atom_id: int, r_cut: float, img_target_size: int = 32) -> np.ndarray:
        """
        ...
        m = -1/self.neighbor_map.beta * np.ones(img_size)
        ...
        return self.neighbor_map.pad(A/v**self.neighbor_map.gamma, img_size, img_target_size)
